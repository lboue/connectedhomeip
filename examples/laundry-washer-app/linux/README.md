# Matter Linux Laundry Washer Example

An example showing the use of Matter on the Linux. The document will describe
how to build and run Matter Linux Laundry Washer Example on Raspberry Pi. This doc
...
-   [Matter Linux Laundry Washer Example](#matter-linux-laundry-washer-example)
    -   [Building](#building)
...
-   Build the example application:
          ...
          $ cd ~/connectedhomeip/examples/laundry-washer-app/linux
...
-   Running
    ...
    -   [Optional] Plug USB Bluetooth dongle
        ...
        -   Run Linux Laundry Washer Example App

                  $ cd ~/connectedhomeip/examples/laundry-washer-app/linux
                  $ sudo out/debug/chip-laundry-washer-app --ble-device [bluetooth device number]
                  # In this example, the device we want to use is hci1
                  $ sudo out/debug/chip-laundry-washer-app --ble-device 1
