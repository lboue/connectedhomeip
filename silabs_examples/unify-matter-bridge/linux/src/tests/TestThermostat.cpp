...
static void TestThermostatAttributeControlSequenceOfOperation(nlTestSuite * sSuite, void * apContext)
{
    ...
    CHIP_ERROR err     = ctx.attribute_test<Attributes::ControlSequenceOfOperation::TypeInfo>(
        ...
        R"({ "value": "CoolingOnly"})", chip::app::Clusters::Thermostat::ThermostatControlSequence::kCoolingOnly);
    CHIP_ERROR err1    = ctx.attribute_test<Attributes::ControlSequenceOfOperation::TypeInfo>(
        sSuite, "ucl/by-unid/zw-0x0002/ep2/Thermostat/Attributes/ControlSequenceOfOperation/Reported", 
        R"({ "value": "CoolingWithReheat"})", chip::app::Clusters::Thermostat::ThermostatControlSequence::kCoolingWithReheat);
    CHIP_ERROR err2    = ctx.attribute_test<Attributes::ControlSequenceOfOperation::TypeInfo>(
        sSuite, "ucl/by-unid/zw-0x0002/ep2/Thermostat/Attributes/ControlSequenceOfOperation/Reported", 
        R"({ "value": "HeatingOnly"})", chip::app::Clusters::Thermostat::ThermostatControlSequence::kHeatingOnly);
    CHIP_ERROR err3    = ctx.attribute_test<Attributes::ControlSequenceOfOperation::TypeInfo>(
        sSuite, "ucl/by-unid/zw-0x0002/ep2/Thermostat/Attributes/ControlSequenceOfOperation/Reported", 
        R"({ "value": "HeatingWithReheat"})", chip::app::Clusters::Thermostat::ThermostatControlSequence::kHeatingWithReheat);
...
static void TestThermostatAttributeSystemMode(nlTestSuite * sSuite, void * apContext)
{
    ...
    CHIP_ERROR err1     = ctx.attribute_test<Attributes::SystemMode::TypeInfo>(
        sSuite, "ucl/by-unid/zw-0x0002/ep2/Thermostat/Attributes/SystemMode/Reported", R"({ "value": "Off"})", ThermostatSystemModeEnum::kOff);
    CHIP_ERROR err2    = ctx.attribute_test<Attributes::SystemMode::TypeInfo>(
        sSuite, "ucl/by-unid/zw-0x0002/ep2/Thermostat/Attributes/SystemMode/Reported", R"({ "value": "Auto"})", ThermostatSystemModeEnum::kAuto);
    CHIP_ERROR err3    = ctx.attribute_test<Attributes::SystemMode::TypeInfo>(
        sSuite, "ucl/by-unid/zw-0x0002/ep2/Thermostat/Attributes/SystemMode/Reported", R"({ "value": "Cool"})", ThermostatSystemModeEnum::kCool);
    CHIP_ERROR err4    = ctx.attribute_test<Attributes::SystemMode::TypeInfo>(
        sSuite, "ucl/by-unid/zw-0x0002/ep2/Thermostat/Attributes/SystemMode/Reported", R"({ "value": "Heat"})", ThermostatSystemModeEnum::kHeat);
    CHIP_ERROR err5    = ctx.attribute_test<Attributes::SystemMode::TypeInfo>(
        sSuite, "ucl/by-unid/zw-0x0002/ep2/Thermostat/Attributes/SystemMode/Reported", R"({ "value": "EmergencyHeat"})", ThermostatSystemModeEnum::kEmergencyHeat);
    CHIP_ERROR err6    = ctx.attribute_test<Attributes::SystemMode::TypeInfo>(
        sSuite, "ucl/by-unid/zw-0x0002/ep2/Thermostat/Attributes/SystemMode/Reported", R"({ "value": "Precooling"})", ThermostatSystemModeEnum::kPrecooling);    
    CHIP_ERROR err7    = ctx.attribute_test<Attributes::SystemMode::TypeInfo>(
        sSuite, "ucl/by-unid/zw-0x0002/ep2/Thermostat/Attributes/SystemMode/Reported", R"({ "value": "FanOnly"})", ThermostatSystemModeEnum::kFanOnly);
    CHIP_ERROR err8    = ctx.attribute_test<Attributes::SystemMode::TypeInfo>(
        sSuite, "ucl/by-unid/zw-0x0002/ep2/Thermostat/Attributes/SystemMode/Reported", R"({ "value": "Dry"})", ThermostatSystemModeEnum::kDry);    
    CHIP_ERROR err9    = ctx.attribute_test<Attributes::SystemMode::TypeInfo>(
        sSuite, "ucl/by-unid/zw-0x0002/ep2/Thermostat/Attributes/SystemMode/Reported", R"({ "value": "Sleep"})", ThermostatSystemModeEnum::kSleep);
...
static void TestThermostatWriteAttributeControlSequenceOfOperation(nlTestSuite * sSuite, void * apContext)
{
    ...
    ctx.attribute_write_test<Attributes::ControlSequenceOfOperation::TypeInfo>(
        ...
        ThermostatControlSequence::kCoolingOnly);
}
...
static void TestThermostatWriteAttributeSystemMode(nlTestSuite * sSuite, void * apContext)
{
    ...
    ctx.attribute_write_test<Attributes::SystemMode::TypeInfo>(
        sSuite, "Thermostat/Commands/WriteAttributes", R"({"SystemMode":"Auto"})", ThermostatSystemModeEnum::kAuto);
}
